...
export function ChessLogo({ className, iconOnly = false }: ChessLogoProps) {
  return (
    <div className={cn("flex items-center gap-3", className)}>
      <div className="bg-primary p-2 rounded-xl shadow-lg shadow-primary/20 flex items-center justify-center overflow-hidden">
        <div className="relative flex items-center justify-center">
          ...
          <span className="absolute text-[8px] font-black text-primary/40 bottom-[-2px] right-[-2px]">2i</span>
        </div>
      </div>
      {!iconOnly && (
        <div className="flex flex-col leading-none">
          <span className="font-black text-xl tracking-tighter italic">2ides</span>
